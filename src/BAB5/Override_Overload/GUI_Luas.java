...
public class GUI_Luas extends javax.swing.JFrame {
    ...
    private void btn_prosesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_prosesActionPerformed
        ...
        if(cmb1.getSelectedIndex() == 0){
            ...
            int panjang = Integer.parseInt(txt_p.getText());
            int lebar = Integer.parseInt(txt_L.getText());
            persegiPanjang.Luas(panjang, lebar);
            Hasil.setText(Integer.toString(persegiPanjang.Luas(panjang, lebar)));
        }else{
            BangunDatar lingkaran = new BangunDatar();
            double jari = Double.parseDouble(txt_p.getText());
            lingkaran.Luas(jari);
            Hasil.setText(Double.toString(lingkaran.Luas(jari)));
        }        
